...
* FIMO uses simple algorifm for finding matches to motif, and since our motif is not very specific it finds a lot of the matches. Still it finds less matches for more specific motif discovered only from significant peaks -  756 vs. 1076.
* In contrast to GACAC motif, discovered for WhiA and WhiB, which has ~15000 occurances in *S. venezuelae* genome, figures above are not that bad.
