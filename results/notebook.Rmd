...
* __PREDetector 2.0__ - updated version to predict regulated genes based on the matrix (motif) not ChIP-seq data
* __ChIPMunk__ - simpler motif discoverer - PWM-based motif discovery present but no Word-based motif discovery, Motif enrichment analysis (new motifs only for known)
* __Peak-motifs__ - almost as powerful as MEME with all characteristics ChipMunk lacks
