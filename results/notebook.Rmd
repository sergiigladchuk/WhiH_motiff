...
4. Perform statistical independence analysis based on created AffyLogC table (significant diff. in affylog 5%) in R based on one-sided Fisher test for probabilities.

###Results

**Independace test for 'Best non-palindromic discriminative motif' (#2 in [this rediscovery](#rediscovery2))**
