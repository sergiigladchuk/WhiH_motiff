...
\title[short Title]{Motif discovery and its analysis for binding sites of WhiH (White H) transcription factor in Streptomyces}
\author[Sample \textit{et~al}.]{Sergii Gladchuk\,$^{\text{\sfb 1,}*}$, Klas Fl{\"a}rdh\,$^{\text{\sfb 2}}$ and Bj{\"o}rn Canb{\"a}ck\,$^{\text{\sfb 2,}*}$}
\address{$^{\text{\sf 1}}$Department of Biology, Bioinformatics Group, Biology Building, SE 22362 Lund, Sweden}
...
\textbf{Contact:} \href{sergii.gladchuk.1522@student.lu.se}\\
